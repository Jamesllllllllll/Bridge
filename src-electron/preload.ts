...
const electronApi: ContextBridgeApi = {
	invoke: {
		...
		catalogGetChartsCount: getInvoker('catalogGetChartsCount'),
		...
		catalogDeleteChart: getInvoker('catalogDeleteChart'),
		catalogDeleteCharts: getInvoker('catalogDeleteCharts'),
		// Video Sync
